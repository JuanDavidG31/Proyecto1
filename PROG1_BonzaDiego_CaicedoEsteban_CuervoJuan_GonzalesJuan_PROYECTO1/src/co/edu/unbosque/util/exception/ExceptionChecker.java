 ...
 * Proporciona varios métodos para validar diferentes tipos de entradas
 * y lanza excepciones personalizadas cuando los datos no cumplen con los
 * criterios esperados.
 * 
 * @autor (Tu nombre)
 * @version 1.0
...
public class ExceptionChecker {
    ...
    /**
     * Verifica si el valor booleano de entrada es válido (debe ser "si" o "no").
     * Si el valor no es válido, lanza la excepción BooleanNotValidInputException.
     * 
    ...
    /**
     * Verifica si un número de tiempo es negativo.
     * Si el número es negativo, lanza la excepción CheckNegativeTime.
     * 
    ...
    /**
     * Verifica si el número de vuelo contiene caracteres no numéricos.
     * Si se encuentra un carácter no numérico, lanza la excepción FlightNumberException.
     * 
    ...
    /**
     * Verifica si el número de pasajeros es mayor a 300.
     * Si el número es mayor a 300, lanza la excepción PassengersNumberException.
     * 
    ...
    /**
     * Verifica si el número de pasajeros es negativo.
     * Si el número es negativo, lanza la excepción PassengersNegativeNumberException.
     * 
     * @param number el número de pasajeros en formato de cadena
     * @throws PassengersNegativeNumberException si el número de pasajeros es negativo
     */
    ...
    /**
     * Verifica si el tiempo proporcionado supera las 24 horas (formato militar).
     * Si el valor es mayor a 2400, lanza la excepción MilitaryHourException.
     * 
