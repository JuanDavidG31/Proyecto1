...
/**
 * La clase InternationalFlightDAO implementa las operaciones CRUD (Crear, Leer, Actualizar, Borrar)
 * para gestionar los vuelos internacionales en el sistema. Maneja la persistencia de datos,
...
public class InternationalFlightDAO implements CRUDOperation<InternationalFlightDTO, InternationalFlight> {
    ...
    /**
     * Constructor de la clase InternationalFlightDAO.
     * Inicializa la lista de vuelos internacionales y verifica la existencia de la carpeta de archivos.
     */
     ...
     * 
     * @return una cadena con todos los vuelos internacionales o un mensaje si la lista está vacía.
     */
    @Override
    ...
    /**
     * Devuelve una lista de objetos InternationalFlightDTO que representan todos los vuelos internacionales.
     * 
     ...
     * 
     * @param newData el objeto InternationalFlightDTO que representa el nuevo vuelo a agregar.
     ...
     * 
     * @param toDelete el objeto InternationalFlightDTO que representa el vuelo a eliminar.
     ...
     * 
     * @param previous el objeto InternationalFlightDTO que representa el vuelo previo.
     * @param newData el objeto InternationalFlightDTO que contiene los nuevos datos.
     ...
     * 
     * @param listaInternationalFlight la lista de vuelos internacionales a establecer.
     */
    ...
    /**
     * Devuelve el nombre del archivo CSV donde se guardan los vuelos internacionales.
     * 
